...
if __name__ == '__main__':
    ...
    while True:
        ...
        if 'wikipedia' in query:
            ...
            speak("Here you go to your Whatsapp\n")
        ...
        elif 'dark' in query or "open dark" in query:
            speak("Here you go with music")
            # music_dir = "G:\\Song"
            music_dir = "E:\\Movies\\Dark\\S3"
            songs = os.listdir(music_dir)
            print(songs)
            random = os.startfile(os.path.join(music_dir, songs[1]))

        elif 'play ipl' in query:
            speak("Here you go with IPL")
            webbrowser.open("https://www.jiocinema.com/sports")


        elif 'play dark' in query:
            speak("Here you go")
            S3_dir="E:\\Movies\\Dark\\S3"
            S3=os.listdir(S3_dir)
            print(S3)
            random=os.startfile(os.path.join(S3_dir,S3[1]))
        ...
        elif "tell me rcb captain" in query:
            speak("Virat Kohli")
